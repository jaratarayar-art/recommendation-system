...
def render_satisfaction_survey(result, search_meta):
    ...
    st.markdown(
        ...
        **ระดับคะแนน:** 5 หมายถึง พึงพอใจ/เห็นด้วย ในระดับ **มากที่สุด**<br>
        4 หมายถึง พึงพอใจ/เห็นด้วย ในระดับ **มาก**<br>
        3 หมายถึง พึงพอใจ/เห็นด้วย ในระดับ **ปานกลาง**<br>
        2 หมายถึง พึงพอใจ/เห็นด้วย ในระดับ **น้อย**<br>
        1 หมายถึง พึงพอใจ/เห็นด้วย ในระดับ **น้อยที่สุด**
        """
    )
